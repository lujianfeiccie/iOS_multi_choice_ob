...
-(void) toolBarRight
{
    ...
    */
    ...
    {
        tmp_filename = m_filename;
        tmp_title = [NSString stringWithFormat:@"%@名词解释题",[m_title substringToIndex:10]];
...
- (void)viewDidLoad {
    ...
    if(!m_bCalcView)
    {
    self.navigationItem.rightBarButtonItem = [ButtonUtil createToolBarButton:@"名词解释题" target:self action:@selector(toolBarRight)];
    }
