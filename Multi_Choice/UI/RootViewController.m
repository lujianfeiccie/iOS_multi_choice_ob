...
- (void)viewDidLoad
{
    ...
    model.m_text = @"2013年7月真题";
    model.m_value = @"2013_07";
    [m_datalist addObject:model];
    
    model = [[ModelData alloc]init];
    model.m_text = @"2012年7月真题";
    model.m_value = @"2012_07";
    [m_datalist addObject:model];
    
    model = [[ModelData alloc]init];
    model.m_text = @"2011年7月真题";
    model.m_value = @"2011_07";
    [m_datalist addObject:model];
